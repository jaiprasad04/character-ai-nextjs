    ...
    <div className={`h-full border border-gray-300 flex justify-center transition-all duration-300 ${hide}`}>
      <div className="w-full max-w-[90%] flex flex-col my-6 mx-3.5">
        <div className="w-full flex justify-between">
          <h1 className="text-gray-900 text-lg font-bold">character.ai</h1>
          ...
          <div>
            <ul className="list-none pl-0 flex flex-col gap-3">
              {tryThese.map((each, index) => (
                <li key={index} className="flex items-center p-1.5 rounded-md w-full cursor-pointer hover:bg-gray-300 hover:scale-110">
